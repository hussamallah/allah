      ...
      <div className="relative z-10 p-6 max-w-6xl mx-auto">
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <div className="bg-black/40 rounded-lg p-4 mt-4">
                <p className="font-bold"
                   style={{ color: config.accentColor }}>This is field law, not personality or luck.</p>
        ...
        <div className="mb-16">
          <div className="backdrop-blur-md border-2 rounded-2xl p-8"
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <div className="bg-black/40 rounded-lg p-4 mt-4">
                <p className="font-bold"
                   style={{ color: config.accentColor }}>That is the field in action.</p>
        ...
        <div className="mb-16">
          <div className="backdrop-blur-md border-2 rounded-2xl p-8"
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <div className="bg-black/40 rounded-lg p-4 mt-4">
                <p className="font-bold"
                   style={{ color: config.accentColor }}>Nothing in this system is theory.</p>
        ...
        <div className="mb-16">
          <div className="backdrop-blur-md border-2 rounded-2xl p-8"
            ...
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p className="font-bold"
                 style={{ color: config.accentColor }}>Field Walkers who finished the path say:</p>
        ...
        <div className="mb-16">
          <div className="backdrop-blur-md border-2 rounded-2xl p-8"
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <div className="bg-black/40 rounded-lg p-4 mt-4">
                <p className="font-bold"
                   style={{ color: config.accentColor }}>If nothing shifts, walk away.</p>
        ...
        <div className="mb-16">
          <div className="backdrop-blur-md border-2 rounded-2xl p-8"
            ...
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              ...
              <div className="bg-black/40 rounded-lg p-4 mt-4">
                <p className="font-bold"
                   style={{ color: config.accentColor }}>The field doesn't wait for doubters.</p>
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-r opacity-0 group-hover:opacity-20 transition-opacity duration-700 animate-pulse"
                 style={{ background: `linear-gradient(to right, ${config.accentColor}, ${config.color})` }}></div>
          </Link>
        </div>
        ...
        <div className="text-center">
          <Link
            href={`/chamber/${archetype}/breaker/the-path`}
