    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-green-900/40 to-emerald-900/40 backdrop-blur-md border-2 border-green-500/50 rounded-2xl p-8 h-full"
              ...
              <div className="space-y-4 text-gray-300">
                <div className="flex items-start space-x-3">
                  ...
                  <span><strong>6 Core Rituals</strong> — foundational practices for shifting your reality.</span>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0 bg-green-400"></div>
          ...
          <div className="group relative transform hover:scale-105 transition-all duration-500">
            <div className="backdrop-blur-md border-2 rounded-2xl p-8 h-full"
                 style={{ 
                   background: `linear-gradient(to bottom right, ${config.color}20, ${config.accentColor}20)`,
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-3xl font-bold mb-2"
                    style={{ color: config.color }}>Field Mastery Subscription</h2>
                <p className="text-lg"
                   style={{ color: config.accentColor }}>*(Paid Monthly—Cancel Anytime)*</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300">
            ...
            <div className="text-center">
              <h4 className="text-xl font-bold mb-3"
                  style={{ color: config.color }}>Go Mastery</h4>
        ...
        <div className="text-center mb-8">
          <div className="border rounded-2xl p-6 backdrop-blur-sm"
            ...
            <p className="text-xl font-bold mb-2"
              ...
              You've seen the truth in yourself.
            </p>
            <p className="text-gray-300 text-lg">
              When you're ready, decode the truth in others.
            </p>
          </div>
        </div>
        ...
        <div className="text-center space-y-6 mb-16">
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href={`/chamber/${archetype}/field-proof/free-walk`}
            ...
            <Link
              href={`/chamber/${archetype}/field-proof/mastery`}
              className="group relative inline-block px-12 py-6 rounded-2xl font-bold text-white transition-all duration-500 hover:scale-105 transform"
              style={{
          ...
          {/* NEW: Decode Others Button */}
          <div className="mt-8">
            <button
              disabled
              className="group relative inline-block px-12 py-6 rounded-2xl font-bold text-gray-400 transition-all duration-500 transform opacity-60 cursor-not-allowed"
              style={{
                background: 'linear-gradient(135deg, #374151 0%, #1f2937 100%)',
                boxShadow: '0 0 20px rgba(156, 163, 175, 0.3)'
              }}
              title="Ready to map someone else's field? Unlock the secrets behind their actions—see who they really are, and how to reach them."
            >
              <span className="relative z-10 flex items-center justify-center text-xl">
                <span className="mr-3">🔮</span>
                Decode Others (Beta)
              </span>
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-gray-600 to-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </button>
            <p className="text-sm text-gray-500 mt-2">Early Access for Field Mastery</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <Link
            href={`/chamber/${archetype}/field-proof`}
