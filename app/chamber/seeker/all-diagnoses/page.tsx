...
export default function SeekerAllDiagnosesPage() {
  const config = getArchetypeConfig('seeker');
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300">Seeker archetype configuration not found.</p>
        </div>
      </div>
    );
  }
