...
export default function EqualizerContentProcessor() {
  ...
  const stages = ['absorber', 'balancer', 'harmonizer', 'integrator', 'synthesizer'];
  const masks = ['absorber', 'balancer', 'harmonizer', 'integrator', 'synthesizer'];
  ...
  const processContent = async () => {
    ...
    try {
      const response = await fetch('/api/process-equalizer-content', {
        method: 'POST',
        headers: {
  ...
  const createTemplate = () => {
    let template = 'EQUALIZER CONTENT TEMPLATE\n';
    template += '===========================\n\n';
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">⚖️ Equalizer Content Processor</h1>
        <p className="text-gray-600">
          Paste your 25,000 words here and the AI will automatically organize them into 25 equalizer test results.
        </p>
      </div>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Each part will be assigned to one of the 25 equalizer stage/mask combinations.
              </p>
            </div>
            <div>
