...
export default function VisionaryContentProcessor() {
  ...
  const stages = ['dreamer', 'visionary', 'innovator', 'pioneer', 'architect'];
  const masks = ['dreamer', 'visionary', 'innovator', 'pioneer', 'architect'];
  ...
  const processContent = async () => {
    ...
    try {
      const response = await fetch('/api/process-visionary-content', {
        method: 'POST',
        headers: {
  ...
  const createTemplate = () => {
    let template = 'VISIONARY CONTENT TEMPLATE\n';
    template += '==========================\n\n';
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">🔮 Visionary Content Processor</h1>
        <p className="text-gray-600">
          Paste your 25,000 words here and the AI will automatically organize them into 25 visionary test results.
        </p>
      </div>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Each part will be assigned to one of the 25 visionary stage/mask combinations.
              </p>
            </div>
            <div>
